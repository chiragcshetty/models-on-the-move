...
def main():
    ...
    inp_size = (batch_size, int(64*factor))
    opt_size = (batch_size, int(10*factor))
    ...
    model, out_gpu = worker.model_setup(model, inp_size)
    ...
    for run_no in range(Nrun):
        ...
        reconfig_happened, model_out, out_gpu_temp = worker.check_reconfig_status()
